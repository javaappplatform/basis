...
/**
 * NOTICE: This is a modified version distributed by the commons-cli package of the apache foundation.
 * commons-cli is issued under the apache 2.0 license.
 * Modified by Hendrik Renken (javaappplatform) to make the help printing much nicer.
 *
...
public class ModHelpFormatter
{
	 ...
	 */
	private static void appendOption(final StringBuilder buff, final Option option, final boolean required)
	{
		if (!required)
		{
			buff.append("[");
	...
	protected StringBuilder renderOptions(StringBuilder sb, int width, Options options, int leftPad, int descPad)
	{
		...
		sb.append("required:");
		sb.append(this.defaultNewLine);
		boolean firstNotRequired = false;

		for (Iterator i = optList.iterator(); i.hasNext();)
		{
			Option option = (Option) i.next();

			if (!firstNotRequired && !option.isRequired())
			{
				sb.append(this.defaultNewLine);
				sb.append("optional:");
				sb.append(this.defaultNewLine);
	...
	private static class OptionComparator implements Comparator
	{
		...
		public int compare(Object o1, Object o2)
		{
			...
			int t = (opt2.isRequired() ? 1 : 0) - (opt1.isRequired() ? 1 : 0);
			if (t != 0)
				return t;
